...
const SectionLeft = forwardRef(
  (
    ...
    return (
      <article
        className={bg ? `${LeftStyles.container} ${bg}` : LeftStyles.container}
        ref={ref}
        id={id ? id : "generic"}
      >
        <figure
          className={
            leftRight === "left"
              ? `${LeftStyles.position2} ${LeftStyles.figure}`
              : `${LeftStyles.position1} ${LeftStyles.figure}`
          }
        >
          <img
        ...
        <section
          className={
            leftRight === "left"
              ? `${LeftStyles.text} ${LeftStyles.position1}`
              : `${LeftStyles.text} ${LeftStyles.position2}`
          }
        >
          {createTitle()}
