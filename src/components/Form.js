...
function Form() {
  ...
  return (
    <article className={FormStyle.form__email}>
      <h2 className={`title--3`}>Formulario de cotización</h2>
      <p className={FormStyle.form__email__info}>
        Te presentamos nuestro formulario de cotización, para que puedas
        solicitar un presupuesto de nuestros servicios. Una vez hayas llenado el
        formulario y clickeado en el botón de enviar, recibirás un mensaje con
        la información para tu evento.
      </p>
      <form
        onSubmit={handleSubmit}
        className={FormStyle.form__email__form}
        autoComplete="off"
      >
        <div className={FormStyle.form__group}>
          ...
          />
          {errors.name && (
            <p className={FormStyle.form__error}>{errors.name}</p>
          )}
        </div>
        <div className={FormStyle.form__group}>
          ...
          />
          {errors.email && (
            <p className={FormStyle.form__error}>{errors.email}</p>
          )}
        </div>
        <div className={FormStyle.form__group}>
          ...
          />
          {errors.phone && (
            <p className={FormStyle.form__error}>{errors.phone}</p>
          )}
        </div>
        <div className={FormStyle.form__group}>
        ...
        <div className={FormStyle.form__group}>
          ...
          <input
            ...
            name="date"
            id="date"
            placeholder="Elije la fecha de tu evento aqui"
            value={form.date}
            onBlur={handleBlur}
            onChange={handleChange}
          />
          {errors.date && (
            <p className={FormStyle.form__error}>{errors.date}</p>
          )}
        </div>
        <div className={FormStyle.form__group}>
          ...
          />
          {errors.guests && (
            <p className={FormStyle.form__error}>{errors.guests}</p>
          )}
        </div>
        <div className={FormStyle.form__group}>
        ...
        <button
          className={`${FormStyle.form__submit} button button--black link--button font--20rem`}
          type="text"
        >
          Enviar
        </button>
