    ...
    <Layout>
      <article className={ContactoStyle.info}>
        <section className={ContactoStyle.info__text}>
          ...
          <p>
            Aqui encontraras todos nuestros datos de contacto, estaremos
          ...
          <div className={ContactoStyle.info__text__container}>
            ...
            <div className={ContactoStyle.info__text__card}>
              ...
              <p>
                <a
                  className="link--reset--black"
                  href="mailto:thecatering.co@outlook.com
                      "
                >
            ...
            <div className={ContactoStyle.info__text__card}>
              <h3>Whatsapp:</h3>
              <p>
                Si deseas contactarnos por whatsapp, puedes hacerlo a través de
                este enlace. Y un Event Planner se contactará contigo lo más
                pronto posible.
              </p>
